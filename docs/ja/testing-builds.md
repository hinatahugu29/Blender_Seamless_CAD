...
macOS で動いたという報告はいただいているので、少なくとも一部の環境では
Gatekeeper を通過しているようです。**ただし下のコマンドが必要だったかどうかまでは
報告に含まれておらず、そこは未解決です。**
...
そして「動いた」という声が数件届いた今、役に立つのは具体的な報告です。
どのツールを使い、それが何をしたか、を書いていただけると助かります。
